...
(defun C:WT (/ objSet startTime)
  ...
  (setq wellTypes '(("ВГ"
		     (("Type" "Смотровой")("Дно" 0.4)("Лестница" "Л2")
		      ("12" (("Base" 1980)("ЖБ M300" 1.0)("МБ М300" 0.26)("Песок" 0.28)("Битум" 9.02)("Битум+" 4.5)))
		      ("15" (("Base" 1980)("ЖБ M300" 1.4)("МБ М300" 0.44)("Песок" 0.38)("Битум" 10.70)("Битум+" 5.4)))
		      ("20" (("Base" 1980)("ЖБ M300" 2.19)("МБ М300" 0.97)("Песок" 0.60)("Битум" 13.93)("Битум+" 7.0)))
		      ("25" (("Base" 1980)("ЖБ M300" 3.19)("МБ М300" 1.60)("Песок" 0.87)("Битум" 18.76)("Битум+" 9.38)))))
		    ("ВД"
		    ...
		    ("ППК"
		     (("Type" "Перепадный")("Дно" 0.7)
		      ("15" (("Base" 1150)("ЖБ M300" 1.4)("МБ М300" 0.44)("Песок" 0.41)("Битум" 4.0)("Битум+" 7.0)))
		      ("20" (("Base" 1190)("ЖБ M300" 2.19)("МБ М300" 0.97)("Песок" 0.50)("Битум" 9.0)("Битум+" 7.0)))))
		    ("КГ"
		     (("Type" "Добор")
		      ("КО-660" 66)
